...
class Admin_Trim_Interface_Test extends WP_UnitTestCase {
	...
	public function test_plugin_framework_class_name() {
		$this->assertTrue( class_exists( 'c2c_AdminTrimInterface_Plugin_049' ) );
	}

	public function test_plugin_framework_version() {
		$this->assertEquals( '049', c2c_AdminTrimInterface::get_instance()->c2c_plugin_version() );
	}

	public function test_get_version() {
		$this->assertEquals( '3.3', c2c_AdminTrimInterface::get_instance()->version() );
	}
